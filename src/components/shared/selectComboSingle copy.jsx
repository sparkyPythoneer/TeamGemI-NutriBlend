...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, Popover, PopoverContent, PopoverTrigger } from "../ui"
...
const ComboboxDemo = ({
    ...
    const width = triggerRef.current && triggerRef.current.clientWidth ? `${triggerRef.current.clientWidth}px` : 'auto'
